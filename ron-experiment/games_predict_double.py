...
print("Standard Prediction: ",win_predictor, score, spread)

#### Compare Home / Visitor Reverse
#Filter games to mirrored home, visitor teams
games = games[games['HOME_TEAM_ID'] == visitor_id]
games = games[games['VISITOR_TEAM_ID'] == home_id]
...
xspread = home_score - visitor_score

# Predict
if predictor > 0.5:
    xwin_predictor = home
else:
    xwin_predictor = visitor

# Mirror Prediction
print("Mirror Prediction: ",xwin_predictor, xscore, xspread)

if xscore < score:
    print("Final Prediction = ", win_predictor, "stage 1")
if xscore > score:
    print("Final Prediction = ", xwin_predictor, "stage 2")